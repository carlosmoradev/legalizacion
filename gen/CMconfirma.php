...
<body>
	<p class="textoConfirma"> Su consecutivo para Legalización de gastos en Caja Menor es: </p>
...
$result = mysqli_query($link, "SELECT * FROM documentos WHERE DOC_SIGLA = 'CM' ORDER BY DOC_ID DESC");
mysqli_data_seek($result, 0);
$extraido = mysqli_fetch_array($result);

echo "CM".$extraido['DOC_ID']."<br/> ";
